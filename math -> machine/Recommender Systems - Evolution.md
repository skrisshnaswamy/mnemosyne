...
>[!NOTE]  📜 Neural Collaborative Filtering by _Xiangnan He_
...
Introduced in the  [**"Wide & Deep Learning for Recommender Systems"**](https://arxiv.org/abs/1606.07792) paper by [**Cheng et al. (2016)**](https://arxiv.org/abs/1606.07792)
...
>[!NOTE] ▶️ Wide & Deep Learning: Memorization + Generalization with TensorFlow (TensorFlow Dev Summit 2017)
...
Now we enter the wave that you listed:

• **Sequence models (RNNs, GRUs, Transformers)**  
• **HSTU, TIGER, etc.** (these are advanced architectures focusing on user behavior modeling, long-term dependencies, better embeddings)

• **Semantic IDs**  
A clever trick from Alibaba and others:  
_turn sparse IDs into dense learnable tokens that capture behavior meaning_  
instead of relying on category or one-hot IDs.

• **Knowledge graphs**  
Used to inject structured relationships (e.g., “this movie shares actors, themes, genres”).  
Helps cold start and diversity.
...
### So… is your understanding broadly right?

Yes — your intuition is in the right zone.  
But the real evolution has a few missing steps and a slightly different ordering.
...
3. Early deep recommenders (Neural MF, YouTube DeepNet, Wide & Deep)
    
4. Two-tower / dual encoders
    
5. Sequence models + Transformers
    
6. Advanced embedding systems (HSTU, TIGER, semantic IDs)
    
7. Knowledge-graph-enhanced recommenders
    
8. **Generative recommendation**
    

If one day you want to build a generative recommender for food orders or movies, touching these areas in order makes sense.

---

### If you're learning from scratch, your study path can be gentle

Here’s the “small steps” version, at an ADHD-friendly pace:

1. **Understand CF and MF** — build tiny toy examples
    
2. **Learn embeddings and two-tower models** — this is the real industry workhorse
    
3. **Learn sequence models** — simple GRUs, then Transformers
    
4. **Learn how items become tokens** — semantic IDs
    
5. **Learn how large models treat recommendation as generation**
    
6. **Finally: build your own tiny generative recommender**
    

Each step builds naturally on what came before.

---

You can grow this story further by exploring how online learning, reinforcement learning, and feedback loops influence recommender systems in real apps. It’s the part of the journey where the technical becomes delightfully ecosystem-shaped.